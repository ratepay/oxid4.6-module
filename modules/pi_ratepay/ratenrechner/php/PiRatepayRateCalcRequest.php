    ...
    <table id="piInstallmentTerms" cellspacing="0">
        <tr>
            <td id="piInstallmentFirstTd">
                <div class="piRpInfoImgDiv">
                    <img onMouseOver="piMouseOver('piRpMouseoverInfoPaymentPrice')" onMouseOut="piMouseOut('piRpMouseoverInfoPaymentPrice')" class="piRpInfoImg" src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png" />
                </div>
                <div class="piRpFloatLeft"><?php echo $pi_lang_cash_payment_price; ?>:</div>
                <div class="piRpRelativePosition">
                    <div class="piRpMouseoverInfo" id="piRpMouseoverInfoPaymentPrice">
                        <?php echo $pi_lang_mouseover_cash_payment_price; ?>
                    </div>
                </div>
            </td>
            <td></td>
        ...
        <tr class="piTableHr">
            <td>
                <div class="piRpInfoImgDiv">
                    <img onMouseOver="piMouseOver('piRpMouseoverInfoServiceCharge')" onMouseOut="piMouseOut('piRpMouseoverInfoServiceCharge')" class="piRpInfoImg" src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png" />
                </div>
                <div class="piRpFloatLeft"><?php echo $pi_lang_service_charge; ?>:</div>
                <div class="piRpRelativePosition">
                    <div class="piRpMouseoverInfo" id="piRpMouseoverInfoServiceCharge">
                        <?php echo $pi_lang_mouseover_service_charge; ?>
                    </div>
                </div>
            </td>
            <td></td>
        ...
        <tr class="piPriceSectionHead">
            <td class="piRpPercentWidth">
                <div class="piRpInfoImgDiv">
                    <img onMouseOver="piMouseOver('piRpMouseoverInfoEffectiveRate')" onMouseOut="piMouseOut('piRpMouseoverInfoEffectiveRate')" class="piRpInfoImg" src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png" />
                </div>
                <div class="piRpFloatLeft"><?php echo $pi_lang_effective_rate; ?>:</div>
                <div class="piRpRelativePosition">
                    <div class="piRpMouseoverInfo" id="piRpMouseoverInfoEffectiveRate">
                        <?php echo $pi_lang_mouseover_effective_rate; ?>
                    </div>
                </div>
            </td>
        ...
        <tr class="piTableHr">
            <td>
                <div class="piRpInfoImgDiv">
                    <img onMouseOver="piMouseOver('piRpMouseoverInfoDebitRate')" onMouseOut="piMouseOut('piRpMouseoverInfoDebitRate')" class="piRpInfoImg" src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png" />
                </div>
        ...
        <tr>
            <td>
                <div class="piRpInfoImgDiv">
                    <img onMouseOver="piMouseOver('piRpMouseoverInfoInterestAmount')" onMouseOut="piMouseOut('piRpMouseoverInfoInterestAmount')" class="piRpInfoImg" src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png" />
                </div>
                <div class="piRpFloatLeft"><?php echo $pi_lang_interest_amount; ?>:</div>
                <div class="piRpRelativePosition">
                    <div class="piRpMouseoverInfo" id="piRpMouseoverInfoInterestAmount">
                        <?php echo $pi_lang_mouseover_interest_amount; ?>
                    </div>
                </div>
            </td>
            <td></td>
        ...
        <tr>
            <td>
                <div class="piRpInfoImgDiv">
                    <img onMouseOver="piMouseOver('piRpMouseoverInfoTotalAmount')" onMouseOut="piMouseOut('piRpMouseoverInfoTotalAmount')" class="piRpInfoImg" src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png" />
                </div>
                <div class="piRpFloatLeft"><b><?php echo $pi_lang_total_amount; ?>:</b></div>
                <div class="piRpRelativePosition">
                    <div class="piRpMouseoverInfo" id="piRpMouseoverInfoTotalAmount">
                        <?php echo $pi_lang_mouseover_total_amount; ?>
                    </div>
                </div>
            </td>
            <td></td>
        ...
        <tr class="piRpyellow piPriceSectionHead">
            <td class="piRpPaddingTop">
                <div class="piRpInfoImgDiv">
                    <img onMouseOver="piMouseOver('piRpMouseoverInfoDurationTime')" onMouseOut="piMouseOut('piRpMouseoverInfoDurationTime')" class="piRpInfoImg" src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png" />
                </div>
                <div class="piRpFloatLeft"><b><?php echo $pi_lang_duration_time; ?>:</b></div>
                <div class="piRpRelativePosition">
                    <div class="piRpMouseoverInfo" id="piRpMouseoverInfoDurationTime">
                        <?php echo $pi_lang_mouseover_duration_time; ?>
                    </div>
                </div>
            </td>
        ...
        <tr class="piRpyellow">
            <td>
                <div class="piRpInfoImgDiv">
                    <img onMouseOver="piMouseOver('piRpMouseoverInfoDurationMonth')" onMouseOut="piMouseOut('piRpMouseoverInfoDurationMonth')" class="piRpInfoImg" src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png" />
                </div>
                <div class="piRpFloatLeft piRpPaddingLeft">
                    <b>
                        <?php echo $pi_resultArray['numberOfRates'];?><?php echo $pi_lang_duration_month;?>:
                    </b>
                </div>
                <div class="piRpRelativePosition">
                    <div class="piRpMouseoverInfo" id="piRpMouseoverInfoDurationMonth">
                        <?php echo $pi_lang_mouseover_duration_month; ?>
                    </div>
                </div>
            </td>
        ...
        <tr class="piRpyellow piRpPaddingBottom">
            <td class="piRpPaddingBottom">
                <div class="piRpInfoImgDiv">
                    <img onMouseOver="piMouseOver('piRpMouseoverInfoLastRate')" onMouseOut="piMouseOut('piRpMouseoverInfoLastRate')" class="piRpInfoImg" src="<?php echo $pi_ratepay_rate_calc_path; ?>images/info-icon.png" />
                </div>
                <div class="piRpFloatLeft piRpPaddingLeft">
                    <b><?php echo $pi_lang_last_rate; ?>:</b>
                </div>
                <div class="piRpRelativePosition">
                    <div class="piRpMouseoverInfo" id="piRpMouseoverInfoLastRate">
                        <?php echo $pi_lang_mouseover_last_rate; ?>
                    </div>
                </div>
            </td>
        ...
        <tr>
            <td colspan="4">
                <div class="piRpCalculationText ">
                    <?php echo $pi_lang_calulation_example; ?>
                </div>
            </td>
        </tr>
    </table>
