    ...
    <tr>
        <td width="100%" align="center" valign="top">
            ...
            <form name="myedit" id="myedit" action="[{ $shop->selflink }]" method="post">
                [{ $shop->hiddensid }]
                <input type="hidden" name="cl" value="pi_ratepay_rate_settings">
                ...
                <table cellspacing="0" cellpadding="0" border="0" height="100%" width="100%">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="center" class="edittext">
                            ...
                            <fieldset title="[{ oxmultilang ident="PI_RATEPAY_RATE_SETTINGS_TITLE" }]" style="padding-left: 5px; padding-right: 5px;">
                                      <legend>[{ oxmultilang ident="PI_RATEPAY_RATE_SETTINGS_TITLE" }]</legend><br>
                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td class="edittext" width="15%">
                                            [{ oxmultilang ident="PI_RATEPAY_RATE_SETTINGS_PROFILEID" }]:&nbsp;
                                        </td>
                                        <td class="edittext">
                                    ...
                                    <tr>
                                        <td class="edittext">
                                            [{ oxmultilang ident="PI_RATEPAY_RATE_SETTINGS_SECURITYCODE" }]:&nbsp;
                                        </td>
                                        <td class="edittext">
                                    ...
                                    <tr>
                                        <td class="edittext">
                                            [{ oxmultilang ident="PI_RATEPAY_RATE_SETTINGS_SANDBOX" }]:&nbsp;
                                        </td>
                                        <td class="edittext">
                                    ...
                                    <tr>
                                        <td class="edittext">
                                            [{ oxmultilang ident="PI_RATEPAY_RATE_LOGGING" }]:&nbsp;
                                        </td>
                                        <td class="edittext">
                                    ...
                                    <tr>
                                        ...
                                        <td class="edittext">
                                            [{ if $settings->pi_ratepay_settings__activate_elv->rawValue == 1}]
                                            <input type="checkbox" name="activateelv" checked='checked' value='on'>
                                            [{else}]
